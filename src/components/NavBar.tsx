        ...
        <div className="flex items-center space-x-2">
          {currentUser ? (
            <div className="flex items-center space-x-4">
              {!userProfile?.isPaid && (
                <Button onClick={onUpgradeClick} className="bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-600 hover:to-blue-700">
                  Upgrade to Pro
                </Button>
              )}
            ...
            <>
              <Button onClick={onLoginClick} variant="ghost" className="text-blue-600 hover:text-blue-700">Login</Button>
              <Button onClick={onSignupClick} className="bg-blue-600 text-white hover:bg-blue-700">Sign Up</Button>
            </>
          )}
        </div>
      </div>
