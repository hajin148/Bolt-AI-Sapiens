/*
  ...
  2. Security
    ...
    - Cascade delete modules when classroom is deleted

  3. Sample Data
    - Create dummy classrooms for user abcd1234@gmail.com
*/
...
BEGIN
  ...
  IF dummy_user_id IS NOT NULL THEN
    ...
    INSERT INTO public.classrooms (id, name, description, color, user_id) VALUES
    (gen_random_uuid(), 'Introduction to Web Development', 'Learn the fundamentals of HTML, CSS, and JavaScript. This comprehensive course covers everything from basic syntax to building interactive web applications. Perfect for beginners who want to start their journey in web development.', '#3B82F6', dummy_user_id),
    (gen_random_uuid(), 'Advanced React Patterns', 'Master advanced React concepts including hooks, context, performance optimization, and modern patterns. Dive deep into component composition, state management, and building scalable React applications.', '#10B981', dummy_user_id),
    (gen_random_uuid(), 'Database Design & SQL', 'Comprehensive guide to database design principles, normalization, and SQL queries. Learn to design efficient database schemas and write complex queries for real-world applications.', '#F59E0B', dummy_user_id)
